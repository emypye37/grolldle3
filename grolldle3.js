...
function checkGuess() {
  ...
  if (guessString === rightGuessString) {
    ...
    toastr.success(
      `I must be psychic cause I knew we'd meet like this again. Too bad for you, though, cause I heard a rumor that there's a link to boobies in the "wrong answer" message of this Grolldle. But <a target="_blank" href="Float2.html">here's</a> something else pretty cool to make it up to you xoxo`
    );
    guessesRemaining = 0;
    return;
  } else {
